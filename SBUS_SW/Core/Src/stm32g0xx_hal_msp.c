...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB11     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, RCin1_Pin|GPIO_PIN_11);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, RCout_Pin|GPIO_PIN_7);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_2|RCin2_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PB9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_8|SBUS_in_Pin);
  ...
  /* USER CODE END USART4_MspDeInit 0 */
    ...
    PA1     ------> USART4_RX
    */
    HAL_GPIO_DeInit(GPIOA, CRSF_Pin|GPIO_PIN_1);
