...
/* Definitions for SW */
osThreadId_t SWHandle;
const osThreadAttr_t SW_attributes = {
  .name = "SW",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* Definitions for SBUS2CRSF */
osThreadId_t SBUS2CRSFHandle;
const osThreadAttr_t SBUS2CRSF_attributes = {
  .name = "SBUS2CRSF",
...
/**
* @brief Function implementing the SBUS2CRSF thread.
* @param argument: Not used
* @retval None
*/
